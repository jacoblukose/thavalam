        ...
        <header className="relative">
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                ...
                <div className="text-xs text-muted-foreground" data-testid="text-app-subtitle">
                  Your bikes. Your mods. Your service story.
                </div>
              </div>
            </div>
            ...
            <div className="hidden items-center gap-2 md:flex">
              ...
              <Link href="/garage" data-testid="link-open-garage">
                <Button
                  className="bg-primary text-primary-foreground"
                  data-testid="button-open-garage"
                >
                  Open garage
            ...
            <Button
              variant="secondary"
              className="md:hidden bg-secondary/60"
            ...
            <div className="rg-noise rounded-[28px] border border-border/70 bg-card/40 p-5 shadow-md backdrop-blur md:p-7">
              <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div className="max-w-xl">
                  <div className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-background/30 px-3 py-1 text-xs font-semibold text-foreground" data-testid="badge-hero-tag">
                    <Sparkles className="size-3.5 text-primary" />
                    Built for motorcycle people
                  </div>
                  <h1
                    className="mt-3 rg-title text-3xl font-semibold leading-[1.05] tracking-tight sm:text-4xl"
                    data-testid="text-hero-title"
                  >
                    A super-clear garage for service history, upgrades, and intervals.
                  </h1>
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground" data-testid="text-hero-description">
                    Keep every bike’s story in one place—services, parts, accessories, and the next interval. Designed to be crisp on mobile, fast to scan, and easy to trust.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2 sm:flex-row">
                  <Button
                    className="bg-primary text-primary-foreground"
                    data-testid="button-cta-add-bike"
                  >
                    <Plus className="mr-2 size-4" />
                    Add a vehicle
                  </Button>
                  <Button
                    variant="secondary"
                    className="bg-secondary/60"
                    data-testid="button-cta-log-service"
                  >
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2" aria-label="Quick stats">
                <StatPill
                  icon={<CalendarClock className="size-4 text-primary" strokeWidth={2.2} />}
                  label="Next interval"
                  value="Due soon on 1 bike"
                />
                <StatPill
                  icon={<BadgeCheck className="size-4 text-primary" strokeWidth={2.2} />}
                  label="Verified logs"
                  value="3 services tracked"
                />
                <StatPill
                  icon={<Fuel className="size-4 text-primary" strokeWidth={2.2} />}
                  label="Touring ready"
                  value="1 bike optimized"
                />
                <StatPill
              ...
              <div className="mt-6">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <div className="rg-title text-base font-semibold" data-testid="text-garage-title">
                      Garage
                    </div>
                    <div className="text-xs text-muted-foreground" data-testid="text-garage-subtitle">
                      Pick a bike to see service history and upcoming intervals.
                    </div>
                  </div>
                  ...
                  <div className="flex flex-1 items-center gap-2 sm:max-w-md">
                    <Input
                      ...
                      placeholder="Search bikes, tags, city…"
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <div
                      className="mt-1 rg-title text-xl font-semibold"
                      data-testid="text-active-nickname"
                    >
                  ...
                  <Badge
                    className="bg-primary text-primary-foreground"
                    data-testid="badge-active-health"
                  >
                ...
                <div className="mt-5 grid gap-3">
                  ...
                  <Tabs defaultValue="history" className="w-full">
                    <TabsList className="grid w-full grid-cols-2 rounded-2xl bg-secondary/60" data-testid="tabs-active">
                    ...
                    <TabsContent value="history" className="mt-4 space-y-3">
                      {history.length === 0 ? (
                        <Card className="rounded-3xl border-border/70 bg-background/20 p-4" data-testid="empty-history">
                          <div className="text-sm font-semibold" data-testid="text-empty-history-title">
                            No service logs yet
                          </div>
                          <div className="mt-1 text-xs text-muted-foreground" data-testid="text-empty-history-subtitle">
                    ...
                    <TabsContent value="build" className="mt-4 space-y-3">
                      <Card className="rounded-3xl border-border/70 bg-background/20 p-4" data-testid="card-build">
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            ...
                            <div className="mt-1 text-xs text-muted-foreground" data-testid="text-build-subtitle">
                              Track upgrades, touring parts, and accessories—so the next owner (or mechanic) understands the bike.
                            </div>
                          </div>
                        ...
                        <div className="mt-4 grid gap-2">
                          {[
                            { k: "Tyres", v: "Pirelli Diablo Rosso IV" },
                            { k: "Exhaust", v: "Slip-on" },
                            { k: "Protection", v: "Crash guards" },
                            { k: "Luggage", v: "Soft panniers" },
                          ].map((row) => (
                            <div
                              key={row.k}
